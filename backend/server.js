...
io.on("connection", (socket) => {
  ...
  socket.on("setup", (userData) => { // users will connect to socket.io on app start in frontend
    socket.join(userData._id);
    socket.emit("connected");
  });
  socket.on("join chat", (room) => {
    // on a chat click , create or join the room(chat id). This is used for typing functionlity in chat
    socket.join(room); 
...
// frontend will add the msg to the repective chat or notification(if not opened the chat)
